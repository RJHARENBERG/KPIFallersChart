...
import {KpiFallersChart, initialState} from "./KpiFallersChart/component";
...
export class Visual implements IVisual {
    ...
    constructor(options: VisualConstructorOptions) {
        this.reactRoot = React.createElement(KpiFallersChart, {});
    ...
    private clear() {
        KpiFallersChart.update(initialState);
    }
}